...
export class PKPNFT__factory {
  ...
  static createInterface(): PKPNFTInterface {
    return new Interface(_abi) as PKPNFTInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PKPNFT {
    return new Contract(address, _abi, runner) as unknown as PKPNFT;
  }
}
