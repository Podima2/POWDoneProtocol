...
export class PKPHelper__factory {
  ...
  static createInterface(): PKPHelperInterface {
    return new Interface(_abi) as PKPHelperInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PKPHelper {
    return new Contract(address, _abi, runner) as unknown as PKPHelper;
  }
}
